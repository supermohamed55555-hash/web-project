...
- 🗺️ **Interactive Leaflet Map:** Real-time visualization of emergency requests.
...
- 🛡️ **Secure Authentication:** Built with **PHP PDO** and **Prepared Statements** to prevent SQL Injection.
...
## 🗺️ Smart Map Logic (Technical Overview)
